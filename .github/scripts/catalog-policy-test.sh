...
assert_workflow_contains 'verify-core-cloud-abi.sh'
assert_workflow_contains 'core-cloud-abi-release-metadata.json'
assert_workflow_contains 'artifact_kind:"shared-library"'
assert_workflow_contains 'new Core releases require the Cloud ABI profile'
assert_workflow_contains 'Core data plane and Cloud ABI do not share one signed source contract'
assert_workflow_contains 'abi_profiles:{cloud_control_linux_glibc_x86_64:'
assert_workflow_contains 'cloud_control_linux_glibc_aarch64:'
